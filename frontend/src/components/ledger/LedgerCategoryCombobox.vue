...
<style scoped>
.ledger-category-fields{display:contents}.ledger-category-fields label{display:flex;min-width:0;flex-direction:column;gap:5px;color:var(--ink2);font-size:12px}.category-combobox{position:relative;min-width:0}.category-combobox input{width:100%;min-width:0;max-width:100%;box-sizing:border-box}.category-options{position:absolute;z-index:40;top:calc(100% + 4px);left:0;right:0;max-height:220px;overflow:auto;padding:4px;border:1px solid var(--line2);border-radius:4px;background:var(--card);box-shadow:0 12px 28px rgba(20,23,28,.14)}.category-options button{display:flex;width:100%;min-height:34px;align-items:center;justify-content:space-between;gap:10px;padding:7px 9px;border:0;border-radius:3px;background:transparent;color:var(--ink2);font-size:12px;text-align:left;cursor:pointer}.category-options button:hover{background:var(--accent-soft);color:var(--ink)}.category-options small{color:var(--muted);font-size:10px}.category-empty{display:block;padding:9px;color:var(--muted);font-size:11px;text-align:center}
</style>
