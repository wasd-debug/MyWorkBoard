...
const navGroups = [
  ...
  { key: 'ledger', label: '个人账本', items: [{ key: 'overview', to: '/ledger', label: '总览', icon: Wallet }, { key: 'details', to: '/ledger/transactions', label: '流水', icon: Tickets }, { key: 'manage', to: '/ledger/manage', label: '管理', icon: CreditCard }] },
